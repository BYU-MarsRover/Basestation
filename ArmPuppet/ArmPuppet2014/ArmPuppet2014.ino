...
void armReport(void){
	...
	if(millis() >= (timestamp+100)){
		...
		/*
		Serial.print("$PUPRPT");
		Serial.write(turret>>8);
		Serial.write(turret);
		Serial.write(shoulder>>8);
		Serial.write(shoulder);
		Serial.write(elbow>>8);
		Serial.write(elbow);
		Serial.write(wristRotate>>8);
		Serial.write(wristRotate);
		Serial.write(wristPitch>>8);
		Serial.write(wristPitch);
		Serial.write(effector>>8);
		Serial.write(effector);
		Serial.write(lock>>8);
		Serial.write(lock);
