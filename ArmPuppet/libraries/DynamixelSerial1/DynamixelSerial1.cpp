...
//#define switchCom(DirPin,Mode) (pinMode(DirPin,Mode)); digitalWrite(2,Mode); //(digitalWrite(DirPin,Mode))  // Switch to TX/RX Mode
//#define switchCom(DirPin,Mode) UCSR2B = (Mode)? (UCSR2B |(_BV(TXEN2)) ): (UCSR2B & ~(_BV(TXEN2))); digitalWrite(DirPin,Mode); //(digitalWrite(DirPin,Mode))  // Switch to TX/RX Mode
#define switchCom(DirPin,Mode) UCSR2B = (Mode)? ((UCSR2B |(_BV(TXEN2))) &(~ _BV(RXEN2)) ): ((UCSR2B |(_BV(RXEN2))) &(~ _BV(TXEN2)) ); digitalWrite(DirPin,Mode); pinMode(16,Mode) //(digitalWrite(DirPin,Mode))  // Switch to TX/RX Mode
